 ...
 *
 * This file adds the required WooCommerce setup functions to the ICTU Theme discipl.org (2019) theme.
 *
...
function author_woocommerce_pagination( $args ) {
	...
	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'discipl' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'discipl' ) );
