 ...
 *
 * This file adds the custom CSS to the ICTU Theme discipl.org (2019) theme's custom WooCommerce stylesheet.
 *
...
function author_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['author-woocommerce-styles'] = array(
...
function author_woocommerce_css() {
	...
	', $color_accent, author_color_contrast( $color_accent ) ) : '';
