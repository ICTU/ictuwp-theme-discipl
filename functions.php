 ...
 *
 * This file adds the functions to the ICTU Theme discipl.org (2019) theme.
 *
...
// Rename menus.
add_theme_support( 'genesis-menus', array( 'primary' => __( 'Header Menu', 'discipl' ), 'secondary' => __( 'After Header Menu', 'discipl' ) ) );
